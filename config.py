...
# এখনো বিজ্ঞাপন (Adsterra ইত্যাদি) যোগ করা হয়নি বলে এটা এই মুহূর্তে একটা fixed
# সংখ্যা - real বিজ্ঞাপন postback যোগ হলে এটাকেও dynamic করা যাবে।
SHORTLINK_REWARD_PER_VIEW = 0.0003
